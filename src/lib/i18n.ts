...
export const messages = {
  ko: {
    ...
    "panel.prevPage": "이전 묶음",
    "panel.nextPage": "다음 묶음",
    "panel.pages": "말 묶음 고르기",
    ...
    "partner.heading": "지금 대화 상대",
    "partner.hint":
      "누구와 이야기하는지 골라요. 상대에 맞춰 말투가 바뀌고, 다른 사람과 한 대화는 섞이지 않아요.",
    "partner.none": "상대 고르기",
    "partner.chip.aria": "지금 대화 상대: {name}. 눌러서 바꿔요.",
    "partner.chip.aria.none": "대화 상대를 골라요.",
    "partner.empty": "아직 대화 상대가 없어요. ＋ 를 눌러 추가해 주세요.",
    "partner.speech.casual": "반말",
    "partner.speech.polite": "존댓말",
    "partner.addTile": "추가",
    "partner.edit": "편집",
    "partner.edit.done": "완료",
    "partner.delete.confirm": "이 상대를 지울까요?",
    "partner.add.heading": "상대 추가",
    "partner.add.mic.idle": "🎤 누르고 호칭을 말해요",
    "partner.add.mic.listening": "듣는 중… 누르면 멈춰요",
    "partner.add.captured": "이렇게 들었어요",
    "partner.add.again": "다시 말하기",
    "partner.add.unsupported": "이 기기에서는 음성 입력이 안 돼요.",
    "partner.add.speechLabel": "이 사람에게 쓰는 말투",
    "partner.add.submit": "추가하기",
    "partner.add.cancel": "취소",
  ...
  en: {
    ...
    "panel.prevPage": "Previous set",
    "panel.nextPage": "Next set",
    "panel.pages": "Choose a phrase set",
    ...
    "partner.heading": "Who he's talking with",
    "partner.hint":
      "Pick who he's speaking to. The reply tone adapts to them, and conversations with different people stay separate.",
    "partner.none": "Pick a person",
    "partner.chip.aria": "Talking with {name}. Tap to change.",
    "partner.chip.aria.none": "Pick who he's talking with.",
    "partner.empty": "No people yet. Tap ＋ to add one.",
    "partner.speech.casual": "Casual (반말)",
    "partner.speech.polite": "Polite (존댓말)",
    "partner.addTile": "Add",
    "partner.edit": "Edit",
    "partner.edit.done": "Done",
    "partner.delete.confirm": "Delete this person?",
    "partner.add.heading": "Add a person",
    "partner.add.mic.idle": "🎤 Tap, then say who they are",
    "partner.add.mic.listening": "Listening… tap to stop",
    "partner.add.captured": "Heard this",
    "partner.add.again": "Say again",
    "partner.add.unsupported": "Voice input isn't available on this device.",
    "partner.add.speechLabel": "How he speaks to this person",
    "partner.add.submit": "Add",
    "partner.add.cancel": "Cancel",
