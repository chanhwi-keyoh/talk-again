...
export const messages = {
  ...
  en: {
    ...
    "partner.empty": "No people yet. Add one below.",
    ...
    "partner.add.namePlaceholder": "e.g. granddaughter, wife, doctor",
